...
# recovery comparison ACTT 2 vs 3
    ...
    bootfun = function(dat23, nboot, n.imputations) {
      ...
      for (b in 1:nboot){
        ...
        for (i in 1:n.imputations) {
          ...
          coxfit=coxph(Surv(tte_recov, recovered) ~ comparison.group.flag, 
...
save(boothrs1, file=
  paste('boothrs_recovery23', '_', n.imputations,'imputations_',nboot, '_resamples','_',seed, sep=''))
